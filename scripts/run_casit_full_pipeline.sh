...
echo ""
echo "[0/18] VLM server kontrol ediliyor..."
"$PY_VLM" - << PY
...
echo ""
echo "[3/18] Event energy scanner çalışıyor..."
...
echo ""
echo "[4/18] Context window planner çalışıyor..."
...
echo ""
echo "[5/18] Detail window extractor çalışıyor..."
...
echo ""
echo "[6/18] Scene scout extractor çalışıyor..."
...
echo ""
echo "[7/18] Qwen/VLM Scene Prior Agent çalışıyor..."
...
echo ""
echo "[8/18] Domain policy seçiliyor..."
...
echo ""
echo "[9/18] Domain-aware YOLO çalışıyor..."
...
echo ""
echo "[11/18] Relation dynamics analyzer çalışıyor..."
...
echo ""
echo "[12/18] Proximity risk engine çalışıyor..."
...
echo ""
echo "[13/18] Track quality refiner çalışıyor..."
...
echo ""
echo "[14/18] Event evidence builder çalışıyor..."
...
echo ""
echo "[15/18] Final Türkçe rapor üretiliyor..."
...
echo ""
echo "[16/18] Semantik olay raporu üretiliyor..."
...
echo ""
echo "[17/18] Senaryo 3 karar destek çıktısı üretiliyor..."
...
echo ""
echo "[18/18] Senaryo 3 çıktı kalite kontrolü yapılıyor..."
