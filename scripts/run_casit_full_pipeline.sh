...
echo ""
echo "[0/24] VLM server kontrol ediliyor..."
"$PY_VLM" - << PY
...
echo ""
echo "[3/24] Event energy scanner çalışıyor..."
...
echo ""
echo "[4/24] Context window planner çalışıyor..."
...
echo ""
echo "[5/24] Detail window extractor çalışıyor..."
...
echo ""
echo "[6/24] Scene scout extractor çalışıyor..."
...
echo ""
echo "[7/24] Qwen/VLM Scene Prior Agent çalışıyor..."
...
echo ""
echo "[8/24] Domain policy seçiliyor..."
...
echo ""
echo "[9/24] Domain-aware YOLO çalışıyor..."
...
echo ""
echo "[11/24] Relation dynamics analyzer çalışıyor..."
...
echo ""
echo "[12/24] Proximity risk engine çalışıyor..."
...
echo ""
echo "[13/24] Track quality refiner çalışıyor..."
...
echo ""
echo "[14/24] Event evidence builder çalışıyor..."
...
echo ""
echo "[15/24] Final Türkçe rapor üretiliyor..."
...
echo ""
echo "[16/24] Semantik olay raporu üretiliyor..."
...
echo ""
echo "[17/24] Event VLM Reasoner çalışıyor..."
...
echo ""
echo "[18/24] Risk & Action Engine v2 çalışıyor..."
...
echo ""
echo "[19/24] Senaryo 3 karar destek çıktısı üretiliyor..."
...
echo ""
echo "[20/24] JSON Schema Standardizer çalışıyor..."
...
echo ""
echo "[21/24] Scenario 3 Output Validator çalışıyor..."
...
echo ""
echo "[22/24] Senaryo 3 çıktı kalite kontrolü yapılıyor..."
